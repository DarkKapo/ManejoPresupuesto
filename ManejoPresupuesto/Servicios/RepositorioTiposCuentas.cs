...
namespace ManejoPresupuesto.Servicios
{
	...
	public class RepositorioTiposCuentas: IRepositorioTiposCuentas
	{
		...
		//Agregar Obtener a la interface con CTRL + .
		public async Task<IEnumerable<TipoCuenta>> Obtener(int usuarioId)
		{
			using var connection = new SqlConnection( connectionString );
			//Envía el resultado de la query a la clase TipoCuenta
			//Retorna un Ienumerable porque son varias filas
		...
		{
			using var connection = new SqlConnection( connectionString );
			//Execute ejecuta una query que no retorna datos
			await connection.ExecuteAsync(@"UPDATE TiposCuentas
											SET Nombre = @Nombre
											WHERE Id = @Id", tipoCuenta);
		}
		//Carga los datos del tipo cuenta de X id
		...
		//Agregar a la interface con CTRL + .
		...
		//Actualiza el orden de la lista Tipos Cuentas, agregar con CTRL + .
